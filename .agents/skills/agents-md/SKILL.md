...
```markdown
## Commit Attribution
You must NEVER git commit code to the repository unless you have been explicitly instructed to do so by the user. This is so the user can review the code and approve the changes before they are committed.
If you have been specifically and explicitly instructed to commit code to the repository, you must include the following attribution in your commit message:
```
